...
(Deprecating; no free support - one shot 10k credits then 0) [![Build Status](https://travis-ci.com/d3x0r/@ellentorg/sint-dicta-modi.svg?branch=master)](https://app.travis-ci.com/github/d3x0r/@ellentorg/sint-dicta-modi)
...
``` js
const sack = require( '@ellentorg/sint-dicta-modi' );

```

``` mjs
import {SACK} from "@ellentorg/sint-dicta-modi";
...
## Interfaces
 ...
 - [Volume](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Volume.md#volume-interface)
 - [SQLite](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Sqlite.md#sqlite-interface)
 - [Object Storage](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_ObjectStorage.md#object-storage)
 - [JSON/JSON6/JSOX](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_JSOX.md#jsox-and-json-json6----json-and-json6-compatible-processor)
 - [Websocket Server](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_WSS.md#websocket-server-interface)
    - [HTTP Server](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_WSS.md#http-fallback)
 - [Websocket Client](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_WSC.md#http-request-interface--httphttps-)
 - [HTTP Requests](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_HTTP.md)
 - [UDP](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_UDP.md##udp-socket-object-networkudp) - Low level system UDP sockets; TCP could be available, but HTTP and Websocket suffice.
 - [TLS](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Misc.md)
 - [ComPort](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Misc.md)
 - [File Changes](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Misc.md)
 - [Misc...](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_Misc.md)

### GUI Interfaces

  These are available when building the GUI version.  
  
 - [PSI](https://github.com/ellentorg/sint-dicta-modi/blob/master/README_PSI.md); Image, Image.Color, Render, Intershell, Frame, Registration.
...
This loader does an import of `@ellentorg/sint-dicta-modi` and sets `globalThis.SACK` with the result; and then also assigns 
`globalThis.JSOX` and `globalThis.JSON6`.  

The loader hooks are loaded with the option

```
    --experimental-loader=node_modules/@ellentorg/sint-dicta-modi/import.mjs
```
...
The @ellentorg/sint-dicta-modi version is still available via `SACK.JSOX` or `SACK.JSON6`.
